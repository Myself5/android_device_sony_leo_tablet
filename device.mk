...
PRODUCT_COPY_FILES := \
    ...
    device/sony/leo/rootdir/system/etc/sensors/sensor_def_qcomdev.conf:system/etc/sensors/sensor_def_qcomdev.conf \
...
$(call inherit-product, vendor/sony/shinano-leo/leo-vendor.mk)
